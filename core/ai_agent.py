...
class AI:
    ...
    def get_embeddings(self):
        ...
        self.chunk_embeddings = embedder.embed_documents(self.text_chunk) #embed the chunks.
    ...
    def load_db(self):
        self.db =FAISS.load_local(self.presistant_directory,HuggingFaceBgeEmbeddings(model_name="sentence-transformers/all-mini-L6-v2"),allow_dangerous_deserialization=True)
